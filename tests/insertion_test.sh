...
dd if=test3.bef of=test3.bef.tmp bs=4K count=1023
...
dd if=test3.bef of=test3.bef.tmp bs=4K count=1024
dd if=/dev/zero of=test3.bef.tmp bs=4K oseek=1024 count=1
dd if=test3.bef bs=4M iseek=1 >> test3.bef.tmp
